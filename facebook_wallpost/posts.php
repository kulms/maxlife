...
//		mysql_query("INSERT INTO facebook_posts (post,f_name,userip,date_created,userid,courseid) VALUES('".checkValues($_REQUEST['value'])."','".$_POST['post_name']."','".$userip."','".strtotime(date("Y-m-d H:i:s"))."',".$_REQUEST['uid'].",".$_POST['course_id'].")");

		if($_REQUEST['cid'] > 0){
			$qcourse=mysql_query("SELECT name,section FROM courses WHERE id=".$_REQUEST['cid']."");
		...
		//mysql_query("INSERT INTO facebook_posts (post,f_name,userip,date_created,userid) VALUES('".checkValues($_REQUEST['value'])."','MaxLearn','".$userip."','".strtotime(date("Y-m-d H:i:s"))."',".$_REQUEST['uid'].")");
		mysql_query("INSERT INTO facebook_posts (post,f_name,userip,date_created,userid,courseid) VALUES('".checkValues($_REQUEST['value'])."','".$postname."','".$userip."','".strtotime(date("Y-m-d H:i:s"))."',".$_REQUEST['uid'].",".$_REQUEST['cid'].")");
		//mysql_query("INSERT INTO facebook_posts (post,f_name,userip,date_created,userid,courseid) VALUES('".checkValues($_REQUEST['value'])."','MaxLearn','".$userip."','".strtotime(date("Y-m-d H:i:s"))."',".$_REQUEST['uid'].",".$_SESSION["cid"].")");
	...
	while ($row = mysql_fetch_array($result))
	{
       ...
       <img src="<?php echo getUserImg($row['userid']);?>" width="42" class="CommentImg" style="float:left;" alt="" />
...
<!--<div id="CommentPosted<?php  echo $row['p_id']?>">-->
			...
			echo "few seconds ago";	
						...
						if($rows['userid'] == $_SESSION["uid"] || $_SESSION["ucat"] == 2){
						?>
...
<!--<img src="small.png" width="40" class="CommentImg" style="float:left;" alt="" />-->
                <!--<img src="gear_icon.png" width="40" class="CommentImg" style="float:left;" alt="" />-->
                <img src="<?php echo getUserImg($_SESSION["uid"]);?>" width="42" class="CommentImg" style="float:left;" alt="" />
